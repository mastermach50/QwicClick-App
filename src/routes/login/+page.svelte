<script>
    ...
    let login_field = {login_usn: "", login_pwd: ""}, valid = false;
        ...
        <div class="formfield">
            <form class="login form" on:submit|preventDefault={checkFields}>
                ...
                <div>
                    ...
                    <input id="login_usn" type="text" placeholder="Enter Username.. "  bind:value={login_field.login_usn}><br>
                    <div class="error">{errors.login_usn}</div>
                </div>
                <div>
                    <label for="login_pwd">Password : </label><br>
                    <input id="login_pwd" type="password" placeholder="Enter Password.. "  bind:value={login_field.login_pwd}><br>
